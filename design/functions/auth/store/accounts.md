...
Deleted account records remain as subject tombstones. Identity reuse policy controls whether the same
external identity may point at a new subject after retention; it never reactivates or reuses the
deleted account subject.
