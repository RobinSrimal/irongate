...
Metadata advertises the implemented OAuth/OIDC endpoints and JWKS. Access tokens are
self-contained JWTs, and resource APIs validate them locally with JWKS metadata.
