...
Access tokens are self-contained JWTs. Resource APIs validate those JWTs locally through issuer,
audience, expiry, signature, and scopes using discovery/JWKS metadata.
